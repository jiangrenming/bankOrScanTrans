...
public class EMVFailWater implements Serializable{
    ...
    private String translocalyear ; //操作年份
    ...
    public String acceptoridcode;//商户号
    ...
    public String getTranslocalyear() {
        return translocalyear;
    }

    public void setTranslocalyear(String translocalyear) {
        this.translocalyear = translocalyear;
    }
