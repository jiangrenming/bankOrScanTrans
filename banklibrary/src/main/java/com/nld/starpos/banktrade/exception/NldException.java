...
public class NldException extends Exception{
	
	private String errorCode;
	
	public NldException(String errorCode) {
	...
	public static String getExpCode(Exception e,String defcode){
		...
		if (e instanceof JSONException) {
			retCode= NldException.ERR_DAT_JSON_E207;
		} else if (e instanceof HttpStatusException) {
			retCode= NldException.ERR_NET_HTTPSTATUS_E105;
		} else if (e instanceof ConnectException ) {
			retCode= NldException.ERR_NET_CONNECT_E103;
		} else if (e instanceof SocketException ) {
			retCode= NldException.ERR_NET_SOCKET_E104;
		} else if (e instanceof SocketTimeoutException) {
			retCode= NldException.ERR_NET_SOCKET_TIMEOUT_E106;
		} else if (e instanceof ConnectTimeoutException) {
			retCode= NldException.ERR_NET_CONNECT_TIMEOUT_E107;
		} else if (e instanceof FileNotFoundException) {
			retCode= NldException.ERR_DAT_FILENOTFOUND_E204;
		} else if (e instanceof ExPinPadException) {
			retCode= NldException.ERR_DEV_EXPINPAD_E316;
		} else if (e instanceof NullConnectAddressException) {
			retCode= NldException.ERR_NET_URL_NULL_E108;
		} else if (e instanceof UnknownHostException) {
			retCode= NldException.ERR_NET_UNKNOWNHOST_E109;
		} else if (e instanceof EOFException) {
			retCode= NldException.ERR_DAT_EOF_E208;
		}
		if(retCode.equals("")){
			return defcode;
		}
