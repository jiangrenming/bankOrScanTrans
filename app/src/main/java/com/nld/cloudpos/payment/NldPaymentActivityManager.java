package com.nld.cloudpos.payment;
 ...
 *
 */
public class NldPaymentActivityManager {

	private static Stack<Activity> activityStack;
	private static NldPaymentActivityManager instance;
	 ...
	 * @return
	 */
	public static synchronized NldPaymentActivityManager getActivityManager() {

		if (instance == null) {
			instance = new NldPaymentActivityManager();
...
//				LogUtils.d("remove:" + activity.getClass().getName().toString());
//				LogUtils.d("activityStack.size:" + activityStack.size());
				activity = null;
			}
		}
	}
